...
def bracket_strategy_description(strategy):
    descs = {
        ...
        "simulation": {
            ...
            "desc": "Based on 10,000 Monte Carlo simulations. Picks the most likely outcome at every branch. Slightly different from chalk due to path dependencies.",
...
<body>
    <header>
        ...
        <div class="meta">
            10,000 Monte Carlo Simulations | KenPom Analytics | Injury-Adjusted | Travel-Factored<br>
    ...
    <div class="container">
        ...
        <section id="overview">
            ...
            <div class="insight-grid">
                ...
                <div class="insight-card" style="border-top: 3px solid var(--accent);">
                    <h4>BREAKING - March 18 Updates</h4>
                    <p style="color:var(--red);"><strong>Louisville's Mikel Brown Jr. OUT</strong> for opening weekend (back). 18.2 PPG, lottery pick.</p>
                    <p style="color:var(--red);"><strong>Duke's Ngongba "unlikely"</strong> per Coach Scheyer. Two starters now out.</p>
                    <p style="color:var(--red);"><strong>Michigan's Cason: torn ACL</strong> (season-ending). Worse than reported.</p>
                    <p style="color:var(--green);"><strong>First Four Results:</strong> Howard 86-83 UMBC | Texas 68-66 NC State (buzzer beater)</p>
                    <p><strong>Tonight:</strong> Lehigh (-3.5) vs PV A&M 6:40pm | SMU (-7.5) vs Miami OH (31-1!) 9:15pm</p>
                </div>
                <div class="insight-card">
                ...
                <div class="insight-card">
                    <h4>Strategy by Pool Size</h4>
                    <p><strong>10 people:</strong> Play chalk. Maximize expected points. Use "The Analyst."</p>
                    <p><strong>30 people:</strong> Mostly chalk + 1-2 strategic upsets. Use "The Strategist."</p>
                    <p><strong>50 people:</strong> Need differentiation. Use "The Value Hunter."</p>
                    <p><strong>1000 people:</strong> Must go contrarian. Use "The Contrarian." Everyone else picks chalk.</p>
                </div>
            </div>
        </section>
        ...
        <section id="championship">
            <h2>Championship Probabilities (10,000 Simulations)</h2>
            <table>
                <thead>
                    <tr>
                        <th>Team</th>
        ...
        <section id="brackets">
            ...
            <p style="color: var(--text-muted); margin-bottom: 20px;">
                Each bracket is optimized for a different pool size and risk profile.
                Your 4 pools: 10 people (Analyst), 30 people (Strategist/Value), 50 people (Value/Balanced), 1000 people (Contrarian).
                The Simulator and Chaos Agent are bonus entries for flexibility.
            </p>
            {bracket_sections}
        </section>
        ...
        <section id="live-odds">
            ...
            <table>
                ...
                <tbody>
                    <tr><td>12:15p</td><td>(8) Ohio State vs (9) TCU</td><td>OSU -2.5</td><td>145.5</td><td>-142</td><td>+120</td><td style="color:var(--gold);">Coin flip. Lean TCU +2.5</td></tr>
                    <tr><td>12:40p</td><td>(4) Nebraska vs (13) Troy</td><td>NEB -12.5</td><td>137.5</td><td>-1000</td><td>+650</td><td>CBS Cinderella pick. Troy +12.5 has value.</td></tr>
                    <tr class="has-edge"><td>1:30p</td><td>(6) Louisville vs (11) South Florida</td><td>LOU -4.5</td><td>164.5</td><td>-205</td><td>+170</td><td style="color:var(--green);font-weight:bold;">USF +4.5 / ML +170. Brown OUT = huge edge.</td></tr>
                    <tr><td>1:50p</td><td>(5) Wisconsin vs (12) High Point</td><td>WIS -10.5</td><td>163.5</td><td>-500</td><td>+380</td><td>WIS covers. Not enough talent from HPU.</td></tr>
                    <tr><td>2:50p</td><td>(1) Duke vs (16) Siena</td><td>DUKE -27.5</td><td>135.5</td><td>-20000</td><td>+3500</td><td>Duke covers. No value either side.</td></tr>
                    <tr><td>3:15p</td><td>(5) Vanderbilt vs (12) McNeese</td><td>VAN -15.5</td><td>144.5</td><td>-1200</td><td>+700</td><td>McNeese +15.5 frisky but Vandy too talented.</td></tr>
                    <tr><td>~4pm</td><td>(3) Michigan State vs (14) NDSU</td><td>TBD</td><td>TBD</td><td></td><td></td><td>Izzo in March. MSU rolls.</td></tr>
                    <tr><td>~4:30p</td><td>(4) Arkansas vs (13) Hawaii</td><td>TBD</td><td>TBD</td><td></td><td></td><td>Hawaii traveled 2,594 miles. ARK covers big.</td></tr>
                </tbody>
            </table>
        </section>
